 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".presentation__slider")) new swiper_core_Swiper(".presentation__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
...
***************************************************************************** */
        ...
        class ActionDetails {
            constructor(opts) {
                ...
                while (this.value.slice(this.cursorPos) !== this.oldValue.slice(this.oldSelection.end)) if (this.value.length - this.cursorPos < this.oldValue.length - this.oldSelection.end) ++this.oldSelection.end; else ++this.cursorPos;
            }
            get startChangePos() {
        ...
        const script_element = document.querySelector(".phone__input");
        const maskOptions = {
